...
var sequential = new Object();
sequential.multihue = [BuGn, BuPu, GnBu, OrRd, PuBu, PuBuGn, PuRd, RdPu, YlGn, YlGnBu, YlOrBr, YlOrRd];
sequential.monohue = [Blues, Greens, Greys, Oranges, Purples, Reds];

var divergent = [BrBG,PiYG, PRGn, PuOr, RdBu, RdGy, RdYlBu, RdYlGn, Spectral];

var qualitative = [Paired, Set3];
